...
// Copied from "SDK/flutter/packages/flutter/test/widgets/scrollable_test.dart".
// Modified to make it suitable for [SizedScrollableArea].
...
Future<void> pumpTest(
  ...
  const testerViewSize = Size(1600.0, 800.0);

  final dpi = tester.view.devicePixelRatio;

  // stub tester screen size.
  tester.view.physicalSize = Size(
    testerViewSize.width * dpi,
    testerViewSize.height * dpi,
  );
    ...
    home: PrimaryScrollController(
      ...
      child: Stack(
        ...
        children: [
          ...
          // did'nt centered to make sure tester can use [SizedScrollableArea]
          // for [tester.drag]/[tester.getCenter].
          SizedBox(
            width: isVert ? 200.0 : double.infinity,
            height: isHoriz ? 200.0 : double.infinity,
            child: CustomScrollView(
              ...
              slivers: <Widget>[
                SliverToBoxAdapter(
                  child: SizedBox(
                    width: isHoriz ? 3200.0 : null,
                    height: isVert ? 3200.0 : null,
                  ),
                ),
              ],
            ),
...
/// Get scroll offset from the actual [Scrollable] widget.
...
void main() {
  group('SizedScrollableArea -', () {
    testWidgets('Flings on different platforms', (WidgetTester tester) async {
      await pumpTest(tester, platform: TargetPlatform.android, primary: true);
      await tester.fling(
        find.byType(SizedScrollableArea),
      ...
      await pumpTest(tester, platform: TargetPlatform.iOS, primary: true);
      await tester.fling(
        find.byType(SizedScrollableArea),
        const Offset(0.0, -dragOffset),
        1000.0,
      ...
      await pumpTest(tester, platform: TargetPlatform.macOS, primary: true);
      await tester.fling(
        find.byType(SizedScrollableArea),
        const Offset(0.0, -dragOffset),
        1000.0,
      ...
      expect(macOSResult, lessThan(androidResult));
      // iOS is slipperier than Android
      expect(androidResult, lessThan(iOSResult));
      // iOS is slipperier than macOS
      expect(macOSResult, lessThan(iOSResult));
    });

    testWidgets('Holding scroll', (tester) async {
      await pumpTest(tester,
          platform: debugDefaultTargetPlatformOverride, primary: true);
      await tester.drag(
        find.byType(SizedScrollableArea),
      ...
      final TestGesture gesture = await tester.startGesture(
        tester.getCenter(find.byType(SizedScrollableArea), warnIfMissed: true),
      );
    ...
    testWidgets(
      ...
      (WidgetTester tester) async {
        ...
        final TestGesture gesture = await tester.startGesture(tester.getCenter(
          find.byType(SizedScrollableArea),
          warnIfMissed: true,
        ));
    ...
    testWidgets('Scroll pointer signals are handled on Fuchsia',
        (WidgetTester tester) async {
      await pumpTest(tester, platform: TargetPlatform.fuchsia, primary: true);
      final Offset scrollEventLocation =
          tester.getCenter(find.byType(SizedScrollableArea));
    ...
    testWidgets(
      'Scroll axis is not flipped for trackpad',
      (WidgetTester tester) async {
        await pumpTest(
          tester,
          platform: debugDefaultTargetPlatformOverride,
    ...
    testWidgets(
      'Scrolls horizontally when custom key is pressed',
      (WidgetTester tester) async {
        await pumpTest(
          tester,
          platform: debugDefaultTargetPlatformOverride,
    ...
    //     // Starts ignoring when the drag is recognized.
    //     await tester.fling(
    //         find.byType(Scrollable), const Offset(0, -100), 1000);
    //     expect(renderIgnorePointer.ignoring, true);
    //     await tester.pump();
    //
    ...
    //   expect(find.byKey(const ValueKey<String>('Box 0')), findsNothing);
    //   expect(
    //       find.byKey(const ValueKey<String>('Cheap box 52')), findsOneWidget);
    //
    //   expect(expensiveWidgets, 17);
      ...
      Widget buildFrame(Set<ui.PointerDeviceKind>? dragDevices) {
        return MaterialApp(
          ...
          home: PrimaryScrollController(
            ...
            child: Stack(
              children: [
                const SizedScrollableArea.expand(primary: true),
    ...
    testWidgets('Scroll inertia cancel event', (WidgetTester tester) async {
      await pumpTest(tester, platform: null, primary: true);
      await tester.fling(
        find.byType(SizedScrollableArea),
        const Offset(0.0, -dragOffset),
        1000.0,
      ...
      await tester.sendEventToBinding(testPointer
          .hover(tester.getCenter(find.byType(SizedScrollableArea))));
    ...
    testWidgets('deltaToScrollOrigin getter', (WidgetTester tester) async {
      await tester.pumpWidget(MaterialApp(
        home: PrimaryScrollController(
          ...
          child: const Stack(
            children: [
              SizedScrollableArea.expand(primary: true),
      ...
      expect(getScrollOffset(tester), 200);
      final SizedScrollableAreaState sizedScrollableArea =
          tester.state(find.byType(SizedScrollableArea));
      expect(sizedScrollableArea.deltaToScrollOrigin, const Offset(0.0, 200));
    });
    ...
    testWidgets('resolvedPhysics getter', (WidgetTester tester) async {
      ...
      expect(
        types(sizedScrollableArea.resolvedPhysics),
